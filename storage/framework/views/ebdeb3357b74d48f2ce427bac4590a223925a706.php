...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-transparent" style="height: 80px;">
        <div class="container">
            <a class="navbar-brand" href="/home"><h1 class="pe-4" style="color: #1e3878">Navbar</h1></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><p class="change fs-5">Any Thing</p></a>
                    </li>
                </ul>

                <h6 class="change nav-item">
                    <a class="nav-link h5 change" href="#">English</a>
                </h6>
            </div>
        </div>
    </nav>
...
</html><?php /**PATH C:\laragon\www\server\1-web devlopment\2-back_end\2-laravel\Accounting-office\resources\views/project/header.blade.php ENDPATH**/ ?>