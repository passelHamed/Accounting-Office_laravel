  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a href="/" class="logo d-flex align-items-center">
        ...
        <h1>Turki Al-Otaibi<span>.</span></h1>
      </a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 accordion accordion-flush" id="faqlist" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 accordion-item">
            <div class="service-item  position-relative">
              <div class="mb-4">
                <img class="card-img-top" src="{{ asset('download (10).jpg') }}">
              </div>
              ...
              @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 form-group mt-3 mt-md-0">
                    <input type="text" value="{{ old('email') }}" class="form-control" name="email" id="email" placeholder="Your Email">
                    @error('email')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                ...
                <div class="form-group mt-3">
                  <input type="text" value="{{ old('subject') }}" class="form-control" name="subject" id="subject" placeholder="Company Name">
                  @error('subject')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group mt-3">
                  <textarea class="form-control" value="{{ old('message') }}" name="message" rows="7" placeholder="Message"></textarea>
                  @error('message')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
